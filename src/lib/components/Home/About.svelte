<script lang="ts">
    import jip from '$lib/img/JipsPhotos/Jip.png'
    import sailing from '$lib/img/uptosails.jpeg'
    import JipBartBoat from '$lib/img/JipsPhotos/JipBartBoat.png'
    import JipBeau from '$lib/img/JipsPhotos/JipBeau.png'
    import boogieboard from '$lib/img/JipsPhotos/boogieboard.png'
        ...
        <div class="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
            ...
            <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-16">
                <figure class="relative isolate pt-6 sm:pt-12">
                    ...
                    <blockquote class=" tracking-wide  leading-8 text-white md:text-2xl sm:leading-9">
                        <p> Hoi!</p>
                        <p>

                            Ik ben Jip van den Broek, geboren in september 2008, en doe mee aan School at Sea. Watersport is een van mijn passies, toen ik van School at Sea hoorde was het meteen duidelijk: dit moet ik doen!</p>
                        <p>
                            Op dit moment zit ik in het voortraject. Mijn coach helpt mij met doelen stellen, mezelf uit mijn comfortzone halen en plannen kan ik nu als de beste. Daarnaast leer ik successen vieren en beter omgaan met teleurstellingen. Veel te leren dus!

                        </p>
                        <p>
                            Het fundraisingstraject is inmiddels ook gestart, op creatieve manieren probeer ik zoveel mogelijk geld op te halen om mijn reis te kunnen betalen.

                        </p>
                        <p>
                            Naast persoonlijke groei vind ik het belangrijk om iets terug te doen aan onze planeet en oceanen: <b class="tracking-wide">10% van het totaalbedrag wordt gedoneerd aan The Ocean Cleanup!</b>
        ...
        <div class="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
            <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                    <img
                            class="absolute inset-0 h-auto lg:h-full xl:w-full object-fit rounded-2xl bg-gray-800 object-cover  shadow-2xl"
                            src={jip}
                            alt=""
                    />
                </div>
